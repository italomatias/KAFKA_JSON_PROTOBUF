...
public class JsonListener {
    ...
    @KafkaListener(topics = "Json-Topic" , groupId = "Jsonaa" , containerFactory = "jsonListenerFactory")
    public void listenJson(Bordero msg) { //Objeto que será feito o maper do JSON CONVERTER
